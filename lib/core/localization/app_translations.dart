...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    ...
    'en_US': {
      ...
      "create_campaign_step4_promo_goal": "Promotion Goal",
      "create_campaign_step4_promo_goal_hint":
          "Describe your milestone goal here, what you want yo achieve specifically",
      ...
      'brand_campaign_details_agency': 'Agency:',
      ...
      'brand_campaign_details_agency_confirmation_pending':
      ...
      'brand_campaign_details_paid_partial': 'Paid (Partial)',
      ...
      'brand_campaign_details_paid_campaign_amount': 'Paid',
      'brand_campaign_details_due_campaign_amount': 'Due',
      'brand_campaign_details_request_quote': 'Request',
      'brand_campaign_details_accept_quote': 'Accept Quote',
      'brand_campaign_details_pay_due': 'Pay Due',
      'brand_campaign_details_budget_confirmed': 'Budget Confirmed',
    ...
    'bn_BD': {
      ...
      "create_campaign_step4_promo_goal": "প্রমোশনের উদ্দেশ্য লিখুন",
      "create_campaign_step4_promo_goal_hint":
          "আপনার মাইলস্টনের বিস্তারিত উদ্দেশ্য এখানে লিখুন",
      ...
      'brand_campaign_details_agency': 'এজেন্সিঃ',
      ...
      'brand_campaign_details_paid_partial': 'পেইড (আংশিক)',
      ...
      'brand_campaign_details_paid_campaign_amount': 'পরিশোধিত',
      'brand_campaign_details_due_campaign_amount': 'বকেয়া',
      'brand_campaign_details_request_quote': 'রিকোয়েস্ট',
      'brand_campaign_details_accept_quote': 'কোট একসেপ্ট',
      'brand_campaign_details_pay_due': 'বকেয়া পরিশোধ করুন',
      'brand_campaign_details_budget_confirmed': 'বাজেট নিশ্চিত হয়েছে',
