...
import 'influencer_home_locked_controller.dart';

class InfluencerHomeLockedView extends GetView<InfluencerHomeLockedController> {
  const InfluencerHomeLockedView({super.key});
