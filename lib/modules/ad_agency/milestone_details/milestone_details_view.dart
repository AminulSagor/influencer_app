      ...
      child: Column(
        ...
        children: [
          ...
          if (isExpanded) ...[
            ...
            // PROMOTION GOAL
            _HeaderSectionTitle(
              iconPath: 'assets/icons/goal.png', // or Icons.adjust_rounded etc.
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(width: 6.w),
              Text(
                dateLabel, // <- comes from model (job/milestone)
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              Expanded(
                                ...
                                child: CustomTextField(
                                  hintText: 'Reach',
                                  textStyle: textStyle,
                                  controller: submission.metricLabelController,
                                  enabled: isEditable,
                              ...
                              Expanded(
                                ...
                                child: CustomTextField(
                                  hintText: '2.5M',
                                  textStyle: textStyle,
                                  controller: submission.metricValueController,
                                  enabled: isEditable,
                                ),
                              ),
                            ],
                    ...
                    SizedBox(height: 12.h),
                    if (isEditable) _AddAnotherProofButton(onTap: onPickFiles),
                  ],
                ),
              ),
          ],
