// lib/modules/auth/signup_agency/signup_agency_tin_view.dart
...
class SignupAgencyTinView extends GetView<SignupAgencyController> {
  const SignupAgencyTinView({super.key});
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Header
                SignupPageHeader(
                  title: 'agency_tin_title'.tr,
                  subtitle: 'agency_tin_subtitle'.tr,
                  body: 'agency_tin_body'.tr,
                ),
