// lib/modules/auth/signup_brand/signup_brand_social_view.dart
...
class SignupBrandSocialView extends GetView<SignupBrandController> {
  const SignupBrandSocialView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final title = isBrand ? 'brand_social_title'.tr : 'influ_social_title'.tr;
    final subtitle = isBrand
        ? 'brand_social_subtitle'.tr
        : 'influ_social_subtitle'.tr;
    final body = isBrand ? 'brand_social_body'.tr : 'influ_social_body'.tr;
